...
<body>
    ...
    <section id="Home">
		<div class="container-fluid">
            ...
            <div class="col-4 mt-5"><h1>Delivered Orders:</h1>
                <?php
                    $sql_get_reference = "SELECT DISTINCT `ref_id` from `orders` where order_status = 'D' ";
                    $reference_result = mysqli_query($con, $sql_get_reference);
            ...
            <div class="col-4 mt-5"><h1>Cancelled Orders:</h1>
                <?php
                    $sql_get_reference = "SELECT DISTINCT `ref_id` from `orders` where order_status = 'X' ";
                    $reference_result = mysqli_query($con, $sql_get_reference);
